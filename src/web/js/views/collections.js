      ...
      return h('tr.clickable', { onclick: () => customerDialog(r) },
        h('td',
          ...
          h('div.muted', { style: { fontSize: '12px' } },
            ...
            r.over_limit_unknown ? h('span.tag', { style: { marginLeft: '6px' }, title: `No exchange rate to ${work.currency} for ${r.currency} yet, so the credit limit could not be checked.` }, 'Limit unknown') : null)),
